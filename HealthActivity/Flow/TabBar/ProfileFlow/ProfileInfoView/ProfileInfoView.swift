...
class ProfileInfoView: BaseView {
    ...
    private lazy var weightView: ProfileMeasureView = {
        let view = ProfileMeasureView(type: .weight(value: "100"))
        return view
    }()
    
    private lazy var heightView: ProfileMeasureView = {
        let view = ProfileMeasureView(type: .height(value: "97"))
        return view
    }()
    
    private lazy var ageView: ProfileMeasureView = {
        let view = ProfileMeasureView(type: .age(value: "30"))
        return view
    }()
