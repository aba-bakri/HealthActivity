...
struct R: Rswift.Validatable {
  ...
  struct image {
    ...
    /// Image `sss`.
    static let sss = Rswift.ImageResource(bundle: R.hostingBundle, name: "sss")
    /// Image `status`.
    ...
    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "sss", bundle: ..., traitCollection: ...)`
    static func sss(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.sss, compatibleWith: traitCollection)
    }
    #endif
