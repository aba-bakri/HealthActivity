...
public class DTRuler: UIView {
    ...
    public var minScale: Scale
    public var maxScale: Scale
    ...
    public init(scale: Scale, minScale: Scale, maxScale: Scale, width: CGFloat) {
        ...
        layoutRuler(with: self.scale, self.minScale, self.maxScale, width)
        layoutPointer()
    }
    
    // MARK: - Private
    
    public func layoutPointer() {
    ...
    public func layoutRuler(with scale: Scale, _ minScale: Scale, _ maxScale: Scale, _ width: CGFloat) {
